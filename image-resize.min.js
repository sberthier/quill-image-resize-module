...
var Resize = function (_BaseModule) {
    ...
    function Resize() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Resize.__proto__ || Object.getPrototypeOf(Resize)).call.apply(_ref, [this].concat(args))), _this), _this.onCreate = function () {
            ...
            // update image size
            var deltaX = (evt.clientX - _this.dragStartX) * _this.options.scale;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_quill__ = __webpack_require__(15);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_quill___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_quill__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_quill_assets_icons_align_left_svg__ = __webpack_require__(113);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_quill_assets_icons_align_left_svg___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_quill_assets_icons_align_left_svg__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_quill_assets_icons_align_center_svg__ = __webpack_require__(112);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_quill_assets_icons_align_center_svg___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_quill_assets_icons_align_center_svg__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_quill_assets_icons_align_right_svg__ = __webpack_require__(114);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_quill_assets_icons_align_right_svg___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_quill_assets_icons_align_right_svg__);
...
var Parchment = __WEBPACK_IMPORTED_MODULE_0_quill___default.a.imports.parchment;
var Align = __WEBPACK_IMPORTED_MODULE_0_quill___default.a.imports['formats/align'];

var offsetAttributor = new Parchment.Attributor.Attribute('nameClass', 'class', {
	scope: Parchment.Scope.INLINE
});

__WEBPACK_IMPORTED_MODULE_0_quill___default.a.register(offsetAttributor);
...
var Toolbar = function (_BaseModule) {
	...
	function Toolbar() {
		...
		return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Toolbar.__proto__ || Object.getPrototypeOf(Toolbar)).call.apply(_ref, [this].concat(args))), _this), _this.onCreate = function () {
			...
			_this.alignments = [{
				icon: __WEBPACK_IMPORTED_MODULE_1_quill_assets_icons_align_left_svg___default.a,
				apply: function apply() {
					var line = __WEBPACK_IMPORTED_MODULE_0_quill___default.a.find(_this.img).parent;
				...
				icon: __WEBPACK_IMPORTED_MODULE_2_quill_assets_icons_align_center_svg___default.a,
				apply: function apply() {
					var line = __WEBPACK_IMPORTED_MODULE_0_quill___default.a.find(_this.img).parent;
				...
				icon: __WEBPACK_IMPORTED_MODULE_3_quill_assets_icons_align_right_svg___default.a,
				apply: function apply() {
					var line = __WEBPACK_IMPORTED_MODULE_0_quill___default.a.find(_this.img).parent;
...
var apply = __webpack_require__(18),
    ...
    customDefaultsMerge = __webpack_require__(71),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_quill__ = __webpack_require__(15);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_quill___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_quill__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_lodash_defaultsDeep__ = __webpack_require__(41);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__DefaultOptions__ = __webpack_require__(36);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__modules_DisplaySize__ = __webpack_require__(37);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__modules_Toolbar__ = __webpack_require__(39);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__modules_Resize__ = __webpack_require__(38);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__Matrix__ = __webpack_require__(115);
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();
...
var knownModules = { DisplaySize: __WEBPACK_IMPORTED_MODULE_3__modules_DisplaySize__["a" /* DisplaySize */], Toolbar: __WEBPACK_IMPORTED_MODULE_4__modules_Toolbar__["a" /* Toolbar */], Resize: __WEBPACK_IMPORTED_MODULE_5__modules_Resize__["a" /* Resize */] };
...
var ImageResize = function ImageResize(quill) {
	...
	this.repositionElements = function () {
		...
		var scale = _this.options.scale;
		var rotation = _this.options.rotation;
  ...
  */
		...
		console.log('rotation = ', _this.options.rotation);
		...
		// const t = ;
		var t = degrees_to_radians(rotation);
		console.log('t = ', t);

		// https://stackoverflow.com/questions/9971230/calculate-rotated-rectangle-size-from-known-bounding-box-coordinates
		var containerWidth = 1 / (Math.pow(Math.cos(t), 2) - Math.pow(Math.sin(t), 2)) * (containerRect.width * Math.cos(t) - containerRect.height * Math.sin(t));
		var containerHeight = 1 / (Math.pow(Math.cos(t), 2) - Math.pow(Math.sin(t), 2)) * (-containerRect.width * Math.sin(t) + containerRect.height * Math.cos(t));
		var imgWidth = 1 / (Math.pow(Math.cos(t), 2) - Math.pow(Math.sin(t), 2)) * (imgRect.width * Math.cos(t) - imgRect.height * Math.sin(t));
		var imgHeight = 1 / (Math.pow(Math.cos(t), 2) - Math.pow(Math.sin(t), 2)) * (-imgRect.width * Math.sin(t) + imgRect.height * Math.cos(t));

		var containerScaleWidth = containerWidth / containerRect.width;
		var containerScaleHeight = containerHeight / containerRect.height;
		// console.log('containerScaleWidth = ', containerScaleWidth);
		// console.log('containerScaleHeight = ', containerScaleHeight);

		var imgScaleWidth = imgWidth / imgRect.width;
		var imgScaleHeight = imgHeight / imgRect.height;
		// console.log('imgScaleWidth = ', imgScaleWidth);
		// console.log('imgScaleHeight = ', imgScaleHeight);

		var cx = containerHeight * Math.sin(t);
		var cy = containerHeight * Math.cos(t);
		var ix = imgHeight * Math.sin(t);
		var iy = imgHeight * Math.cos(t);
		...
		var p1X = cx;
		var p1Y = 0;
		var p2X = imgRect.left - containerRect.left + ix;
		var p2Y = imgRect.top - containerRect.top + 0;
		...
		var rotLeft = vX * Math.cos(-t) - vY * Math.sin(-t);
		var rotTop = vX * Math.sin(-t) + vY * Math.cos(-t);
	...
	this.checkImage = function (evt) {
		if (_this.img) {
			if (evt.keyCode == 46 || evt.keyCode == 8) {
				(window.Quill || __WEBPACK_IMPORTED_MODULE_0_quill___default.a).find(_this.img).deleteAt(0);
			}
			_this.hide();
		}
	};
	...
	this.options = __WEBPACK_IMPORTED_MODULE_1_lodash_defaultsDeep___default()({}, options, __WEBPACK_IMPORTED_MODULE_2__DefaultOptions__["a" /* default */]);
...
Matrix.prototype = {
  ...
  */
	interpolate: function interpolate(m2, t) {
  ...
  */
	applyToTypedArray: function applyToTypedArray(points) {
  ...
  */
	isIdentity: function isIdentity() {
		return this._isEqual(this.a, 1) && this._isEqual(this.b, 0) && this._isEqual(this.c, 0) && this._isEqual(this.d, 1) && this._isEqual(this.e, 0) && this._isEqual(this.f, 0);
	},
  ...
  */
	isEqual: function isEqual(m) {
		return this._isEqual(this.a, m.a) && this._isEqual(this.b, m.b) && this._isEqual(this.c, m.c) && this._isEqual(this.d, m.d) && this._isEqual(this.e, m.e) && this._isEqual(this.f, m.f);
	},
  ...
  * @private
  */
	_isEqual: function _isEqual(f1, f2) {
